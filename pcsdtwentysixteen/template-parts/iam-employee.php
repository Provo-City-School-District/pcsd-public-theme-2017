...
?>
	<div>
		  <ul class="imagebullets">
			  ...
			  <li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/employee-news.svg" alt="" /><a href="https://employee.provo.edu/news/">Employee News</a></li>
			  <li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/shield.svg" alt="" /><a href="https://employee.provo.edu/covid-resource-page-for-employees/">COVID Resource Page for Employees</a></li>
			  <li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/calendar.svg" alt="" /><a href="https://provo.edu/human-resources/calendars/">Calendars</a>
	  ...
	  <div>
		  <ul class="imagebullets">
			  <li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/departments.svg" alt="" /><a href="https://employee.provo.edu/departments/">Departments</a>
				  <ul class="iamSubMenu subMenu">
			  ...
			  <li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/form.svg" alt="" /><a href="https://employee.provo.edu/forms-documents/">Forms &amp; Docs</a></li>
			<li><img src="<?php echo get_template_directory_uri() .'/assets/icons/' . $iconColor; ?>/policies.svg" alt="" /><a href="https://provo.edu/policies-procedures-forms/">Policies &amp; Procedures</a></li>
