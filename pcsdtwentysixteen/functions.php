...
function pcsd_scripts_styles() {
	...
	wp_register_script( 'slick_slider', 'https://globalassets.provo.edu/slick/slick.min.js', array('jquery'), '1.0.01', true);
	...
	wp_register_script( 'my_custom_scripts',get_template_directory_uri() .'/assets/js/childscripts.js', array('cookie_script','mega_menu','global_scripts'), '1.0.01', true);
	...
	if ( is_front_page() ) {
		wp_enqueue_style( 'frontPageStyle', get_template_directory_uri() . '/assets/css/frontpage.css', '', '1.0.01', false);
	}
}
