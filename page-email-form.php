   			...
   			<article id="activePost" class="activePost">
   				<h2>Contact <?php echo get_the_title($staff_member); ?></h2>
					<form action="https://provo.edu/email-sent/" method='post' id="emailForm">
						...
						<textarea id="message" name="message" placeholder="What would you like to say..." required><?php if(!empty($prefillmessage)) { echo $prefillmessage;} ?></textarea>
						...
						data-sitekey="6LckCL0ZAAAAAGx733fhC7SB8zd3s_aczlGdlnvT" 
