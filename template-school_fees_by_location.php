<?php
	/*
		Template Name: All Fees By Location
	*/
	get_header();
?>
     <main id="mainContent">
				...
				<?php
					...
					*/
					...
					if(in_array( $location_of_fees_to_display['value'], $middle_locations ) or in_array( $location_of_fees_to_display['value'], $high_locations )){
						...
						?>
						<ul>
							<li><a href="https://globalassets.provo.edu/fee-summary/fee_summary_<?php echo $location_of_fees_to_display['value']; ?>.pdf"><?php echo $location_of_fees_to_display['label']; ?> Fee Summary</a></li></li>
						</ul>
						<?php
					}
					...
					if (in_array( $location_of_fees_to_display['value'], $high_locations )) {
			          ...
			          $get_id_sql =  "SELECT post_id,meta_key,meta_value FROM psd_posts,psd_postmeta WHERE post_type = 'school_fees' AND psd_posts.ID = psd_postmeta.post_id AND meta_value = '". $location_of_fees_to_display['value'] ."' ORDER BY post_title";
